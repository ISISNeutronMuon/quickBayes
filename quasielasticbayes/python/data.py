...
from  quasielasticbayes.python.fortran_python import vec, matrix_2, c_vec,c_matrix_2
...
class GRDCom(object):
    def __init__(self,m_d2, m_d, m_p):
        self.DDDPAR = c_matrix_2(m_d,m_p) # components of fit convolved with resolution
        self.FR2PIK = c_matrix_2(m_d2,2) # inelastic peaks
